...
|---|---|
| `ozon-fbo-calculator` | Расчёт плана поставки на FBO Ozon по Excel-отчёту: кластеры, упаковки Das Experten (пасты 72/36, щётки 288/144), исключения платного хранения, флаг дефицита. Это **Excel-in / Excel-out** скилл — не лезет в API. |
